...
import {ValueAccessorBase1} from '../base/value-accessor1';

@Component({
  selector: 'amexio-text-input1',
  templateUrl: './textinput.component.html',
  providers: [{
    provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => AmexioTextInputComponent1), multi: true,
  }, {
    provide: NG_VALIDATORS, useExisting: forwardRef(() => AmexioTextInputComponent1), multi: true,
  }],
  encapsulation: ViewEncapsulation.None,
})

export class AmexioTextInputComponent1 extends ValueAccessorBase1<string> implements OnInit, Validators {
